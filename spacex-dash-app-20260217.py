...
def get_pie_chart(selected_site):
    if selected_site == "ALL":
        ...
        # Group by Launch Site and sum class (1=success, 0=failure) to get number of successes
        site_success = (
        ...
        # Count the successes (1) and failures (0) per site
        outcome_counts = (
            filtered_df["class"]
            .value_counts()
            .reset_index()
        ...
        # Map the numeric (1 or 0) outcome values to easy to understand labels
...
def get_scatter_plot(selected_site, payload_range):
    ...
    # Option to Filter by payload range first for ALL sites or a specific site
    ...
    if selected_site == "ALL":
        ...
        # Format Y axis to show easy to understand labels instead of the 1 or 0 values
        fig.update_yaxes(
            tickmode="array",
            tickvals=[0, 1],
